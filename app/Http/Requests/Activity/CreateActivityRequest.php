...
class CreateActivityRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'avg_time_sec' => ['required','numeric', 'min:0'],
    ...
    public function messages()
    {
        return [
            ...
            'avg_time_sec.required' => "Activity's average time (seconds) is required",
            'avg_time_sec.numeric' => "Activity's average time (seconds) must be numeric",
            'avg_time_sec.min' => "Activity's average time (seconds) must be bigger than 0",
